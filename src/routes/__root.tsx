...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/user-custom-favicon.ico?v=kct-seal-20260806", type: "image/x-icon" },
      { rel: "shortcut icon", href: "/user-custom-favicon.ico?v=kct-seal-20260806", type: "image/x-icon" },
      { rel: "apple-touch-icon", href: "/kct-seal-watermark.jpg" },
    ],
  }),
