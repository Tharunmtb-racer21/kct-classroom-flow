...
export function AppSidebar() {
  ...
  return (
    <aside className="hidden md:flex md:w-64 md:flex-col border-r border-border/60 bg-sidebar/60 backdrop-blur-xl md:h-screen md:sticky md:top-0 overflow-hidden">
